    ...
    <nav class="border-b border-grey-800">
        <div class="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between py-6">
            <ul class="flex flex-col md:flex-row items-center">
                ...
                <li class="md:ml-16">
                    <a class="hover:text-gray-300 mt-3 md:mt-0" href="#">Movies</a>
                </li>
                <li class="md:ml-6">
            ...
            <div class="flex flex-col md:flex-row items-center">
                <div class="relative mt-3 md:mt-0">
                    <input type="text" class="bg-gray-800 text-sm rounded-full w-64 px-4 pl-8 py-1 focus:outline-none focus:shadow-outline"
                        placeholder="Search">
                ...
                <div class="md:ml-4 mt-3 md:mt-0">
                    <a href="#">
                        <img src="/img/avatarr.jpg" alt="avatarr" class="rounded-full w-8 h-8">
                    </a>
                </div>
            </div>
        </div>
