...
@section('content')
    <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            <img src="{{ $movie['poster_path'] }}" alt="{{ $movie['title'] }}" alt="{{ $movie['title'] }}"
                 class="w-64 lg:w-96">
            <div class="md:ml-24">
                ...
                <div x-data="{ isOpen: false }">
                    ...
                    <div class="fixed top-0 left-0 w-full h-full flex items-center shadow-lg overlow-y-auto"
                         style="background-color: rgba(0, 0, 0, .5)" x-show.transition.opacity="isOpen">
                        <div class="container mx-auto lg:px-32 rounded-lg overflow-y-auto">
                            <div class="bg-gray-900 rounded">
                                <div class="flex justify-end pr-4 pt-2" @click=" isOpen = false">
                                ...
                                <div class="modal-body px-8 py-8">
                                    <div class="responsive-container overflow-hidden relative"
                                        ...
                                        <iframe
                                            ...
                                            style="border:0;" allow="autoplay, encrypted-media" allow-fullscreen
                                            width="560" height="135"
                        ...
                        <div class="mt-8">
                            <a href="#">
                                <img src="{{ 'https://image.tmdb.org/t/p/w300/' . $cast['profile_path'] }}"
                                     alt="{{ 'https://image.tmdb.org/t/p/w300/' . $cast['profile_path'] }}"
                                     class="hover:opacity-75 transition ease-in-out duration-150">
                            </a>
                            <div class="mt-2">
                                <a href="#" class="text-lg mt-2 hover:text-gray:300"> {{ $cast['name'] }}
                                </a>
...
image='{{ 'https://image.tmdb.org/t/p/original/' . $image['file_path'] }}'">
                                <img src="{{ 'https://image.tmdb.org/t/p/w500/' . $image['file_path'] }}"
                                     alt="{{ 'https://image.tmdb.org/t/p/w500/' . $image['file_path'] }}"
                                     class="hover:opacity-75 transition ease-in-out duration-150">
                            </a>
                        </div>
                    @else
